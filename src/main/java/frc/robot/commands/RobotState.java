...
public enum RobotState {
  ...
  FAILSAFE_DEEP_CLIMB_UNLATCH(true, false,  new LEDState(Color.kYellow)),
  FAILSAFE_DEEP_CLIMB_DEPLOY(true, false,  new LEDState(Color.kYellow)),
  FAILSAFE_DEEP_CLIMB_RETRACT(true, false,  new LEDState(Color.kYellowGreen)),
  FAILSAFE_DEEP_CLIMB_WAIT(true, false, new LEDState (Color.kGreen)),
  FAILSAFE_PREPARE_DEEP_CLIMB(true, false, new LEDState(Color.kYellowGreen)),
  ...
  PREPARE_FUNNEL_INTAKE(false, true,  new LEDState(Color.kPurple)),
  FUNNEL_INTAKE(false, true,  new LEDState(Color.kWhite)),
  ...
  PRE_SUPERCYCLE_LOW_ALGAE(true, false, new LEDState(Color.kBlue)),
  ...
  PRE_PREPARE_PROCESSOR(true, false, new LEDState(Color.kBlue)),
  ...
  PRE_SUPERCYCLE_HIGH_ALGAE(true, false, new LEDState(Color.kBlue)),
  ...
  FRONT_SCORE_ALGAE(false, false, new LEDState(Color.kBlue)),
  PRE_FRONT_SCORE_ALGAE(true, false, new LEDState(Color.kBlue)),
  FRONT_SCORE_ALGAE_WAIT(false, false, new LEDState(Color.kBlue)),
  FAILSAFE_PREPARE_GROUND_ALGAE_INTAKE(true, false, new LEDState(Color.kBlue)),
  FAILSAFE_GROUND_ALGAE_INTAKE(false, false, new LEDState(Color.kBlue)),
  FAILSAFE_PREPARE_POST_GROUND_ALGAE_INTAKE(true, false, new LEDState(Color.kBlue)),
  FAILSAFE_POST_GROUND_ALGAE_INTAKE(false, false, new LEDState(Color.kBlue)),
  FAILSAFE_PREPARE_GROUND_ALGAE_OUTTAKE(true, false, new LEDState(Color.kBlue)),
  FAILSAFE_GROUND_ALGAE_OUTTAKE(false, false, new LEDState(Color.kBlue)),
