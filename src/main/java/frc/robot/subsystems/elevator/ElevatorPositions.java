...
public class ElevatorPositions {
        ...
        public static double L1 = 0.8;
        public static double L1_ROW1 = 0.8; // 1.2
        public static double L1_ROW2 = 0.9; // 1.57
        public static double L2 = 1.46;
        public static double L3 = 3.14;
        ...
        public static double GROUND_ALGAE = 0.1;
        public static double FAILSAFE_GROUND_ALGAE = 0.3;
        public static final double CAPPED_L4 = 3;
        public static final double CORAL_STATION = 1.15;
        public static double INVERTED_CORAL_STATION = 1.75;
