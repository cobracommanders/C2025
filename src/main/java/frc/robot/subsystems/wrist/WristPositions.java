...
public class WristPositions {
    ...
    public static final double L4_WRIST = 0.475; //44
    ...
    public static final double GROUND_ALGAE_INTAKE = 0.455;
    public static final double FAILSAFE_GROUND_ALGAE_INTAKE = 0.401;
