...
public class DrivetrainSubsystem extends StateMachine<DrivetrainState> {
  ...
  protected void collectInputs() {
    ...
    teleopSpeeds = new ChassisSpeeds(
      -Robot.controls.driver.leftY() * Robot.controls.driver.leftY()*.6 * Robot.controls.driver.leftY() * MaxSpeed, 
      -Robot.controls.driver.leftX() * Robot.controls.driver.leftX()*.6 * Robot.controls.driver.leftX() * MaxSpeed, 
      Robot.controls.driver.rightX() * Robot.controls.driver.rightX()*.6 * Robot.controls.driver.rightX() * MaxAngularRate);
